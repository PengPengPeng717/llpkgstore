...
var verificationCmd = &cobra.Command{
	...
	Long:  ``,
	RunE:  runLLPygVerification,
}

func runLLPygVerificationWithDir(dir string) error {
...
func runLLPygVerification(_ *cobra.Command, _ []string) error {
	...
	for _, path := range paths {
		...
		err := runLLPygVerificationWithDir(absPath)
		if err != nil {
			return err
		}
	}
